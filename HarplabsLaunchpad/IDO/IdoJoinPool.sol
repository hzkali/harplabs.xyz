...
contract JoinPool {
    ...
    mapping(address => mapping(uint256 =>  bool)) public isJoined;
    ...
    returns(bool)
  {
    ...
    require(isJoined[msg.sender][_roundId] == false,'Already joined');
    if (maxSell > 0) {
        require(totalJoined <= maxSell, 'Full slots');
    }
    isJoined[msg.sender][_roundId] = true;
    totalJoined += _amount;
    joinedCount += 1;
